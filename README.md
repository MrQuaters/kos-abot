...
### Application features:
  - Application implements [Software PWM controller](/navigation/src/pwm_controller.h). So bot speed can be set.
### Configuration:   
...
You can build this project with:
  - (quemu image) `./cross-build.sh` [quemu image](/cross-build.sh)
